    ...
    <section className="relative min-h-svh overflow-hidden bg-[#151515]">
      ...
      <div className="container-padding-x relative mx-auto max-w-7xl pt-28 pb-16 lg:pt-32 lg:pb-24">
        <div className="flex flex-col gap-2">
          {/* Title line 1 */}
          <h1
            className="hero-slide-left text-[clamp(64px,11vw,160px)]! font-black leading-none tracking-tight text-primary uppercase"
          ...
          <div className="flex flex-col gap-1 lg:hidden">
            <h1
              className="hero-slide-right anim-delay-1 text-[clamp(64px,11vw,160px)]! font-black leading-none tracking-tight text-white uppercase"
              style={{ fontFamily: "var(--font-orbitron)" }}
            >
              {s.title2}
            </h1>
            <h2
              className="hero-slide-up anim-delay-2 text-[clamp(18px,2.8vw,40px)]! font-black leading-none tracking-wider text-primary uppercase"
              style={{ fontFamily: "var(--font-orbitron)" }}
            >
              {s.subtitle}
            </h2>
          ...
          <div className="hidden lg:flex lg:flex-row lg:items-start lg:gap-0">
            ...
            >
              ...
              <div className="mt-auto flex flex-row items-stretch gap-8">
                {/* Description + button */}
                <div className="hero-slide-up anim-delay-3 flex flex-col justify-between gap-8 max-w-90 flex-1">
                  <p className="text-base leading-relaxed text-white/70">
                    {s.description}
                  </p>
                  <PromoButton href={s.buttonHref ?? "#contacts"}>
